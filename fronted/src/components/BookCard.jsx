...
const BookCard = ({ book, setBooks }) => {
  ...
  return (
    <>
      {/* CARD */}
      <Link to={`/book/${book._id}`} className={`relative block rounded-xl bg-base-100 p-4 border translation=all duration-200 ${isActive ? "border-primary shadow-lg" : "border-base-300"} hover: border-primary hover:shadow-xl`}>
        ...
        <div className="mt-6 flex justify-between items-center">
          ...
          <div className="flex items-center gap-4">
            ...
            {/* DELETE */}
            <div className="tooltip tootip-error" data-tip="Delete book">
              <button onClick={(e) => {
                e.preventDefault();
                setShowModal(true);
              }}
